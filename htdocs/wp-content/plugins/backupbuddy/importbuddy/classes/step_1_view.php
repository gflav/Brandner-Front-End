		...
		<div id="pluginbuddy-tabs-server">
			<div class="tabs-item">
				...
				if ( empty( $backup_archives ) ) { // No backups found.
					...
					echo '</select>';
					echo $this->tip( 'Select the backup file you would like to restore data from. This must be a valid BackupBuddy backup archive with its original filename.', '', true );
				}
				?>
			</div>
		</div>
