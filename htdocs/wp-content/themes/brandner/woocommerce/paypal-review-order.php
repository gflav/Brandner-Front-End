...
<?php elseif (!$hide_button):
    ...
    $cancel_button = '<a class="btn angelleye_cancel" href="' . $cancel_url . '">'.__('Cancel order', 'paypal-for-woocommerce').'</a>';
...
?>
        ...
        <div class="btn-group">
          ...
          <button class="button cls_place_order_own"><?php echo  __( 'Place Order','paypal-for-woocommerce');?></button>
        </div>
