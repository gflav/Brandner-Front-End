...
function addScriptAndStyles(){
	if(is_front_page()):
		wp_enqueue_style('home', get_stylesheet_directory_uri().'/library/css/home.css', array(), '', false);
		wp_enqueue_script('home-js', get_stylesheet_directory_uri().'/library/js/home.js', array('jquery'), '5.1', true);
	endif;
	wp_enqueue_style('custom-css', get_stylesheet_directory_uri().'/library/css/custom.css', array(), '', false);
	wp_enqueue_script('custom-js', get_stylesheet_directory_uri().'/library/js/custom.js', array('jquery'), '6.1', false);
}
