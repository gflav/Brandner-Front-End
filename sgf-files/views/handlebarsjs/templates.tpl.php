        ...
        <div class="modal-body">
          <div class="container">
            <div class="row" id="default-modal-close">
              ...
              <div class="col-sm-6">
				  <h3 class="modal-intro-headline"></h3>
			  </div>
              <div class="col-sm-6"><a class="trigger-modal-close btn-close" href="#"><span class="close-x"><img src="<?php echo get_template_directory_uri(); ?>/views/handlebarsjs/img/close.png"></span></a></div>
            </div>
            <div class="row">
              <div class="col-sm-12">
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-lg-7">
      ...
      <textarea name="message" class="hidden"></textarea>
        ...
        <div class="btn-group">
          <!--<a class="btn btn-submit">Send Quote Request</a>
...
<script id="template-modal-gallery" type="text/x-handlebars-template">
  ...
  <div class="row modal-gallery-header">
    ...
    <div class="col-sm-3">
        <a class="trigger-modal-close" href="#"><span class="close-x"><img src="<?php echo get_template_directory_uri(); ?>/views/handlebarsjs/img/close.png"></span></a>
    </div>
   </div>
  <div class="row">
    <div class="col-sm-12">
  ...
  <div class="row modal-gallery-nav">
    <div class="col-sm-9">
      <a href="#" class="btn-prev"><span class="icon-triangle-up"></span>Back</a> /
      <a href="#" class="btn-next">Forward<span class="icon-triangle-up"></span></a>
    </div>
    <div class="col-sm-3 counter" >
      <span class="current-item">1</span> <span class="countsep">/</span> {{count}}
    </div>
  </div>
  {{/if_gt}}
</script>